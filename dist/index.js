...
Module.directive('datePicker', function datePickerDirective(datePickerConfig, $parse, $timeout) {
  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      /* LIRON ADDED DISMISS OPTION TO DATEPICKER WITHOU INPUT */
      scope.dismiss = attrs.dismiss ? $parse(attrs.dismiss)(scope) : dateTimeConfig.dismiss;
      /* LIRON CHANGE END */
      ...
      scope.setDate = function (date) {
        ...
        /* LIRON ADDED dismiss options on dropdown */
        if (scope.dismiss) {
          $timeout(function() {
